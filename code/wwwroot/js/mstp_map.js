...
$(function () {
    if ($('#line-chart')[0]) {
        var d1 = [[1,85], [2,90], [3,83], [4,64], [5,72], [6,87], [7,92], [8,160], [9,95], [10,83], [11,94],[12,86]];
        ...
        $("#line-chart").bind("plothover", function (event, pos, item) {
            if (item) {
                ...
                $("#linechart-tooltip").html(item.series.label + ":" + y +"(K)").css({top: item.pageY+5, left: item.pageX+5}).fadeIn(200);
            }
            else {
